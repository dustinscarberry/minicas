...
class CasEndpointController extends AbstractController
{
  ...
  public function samlValidate(Request $req, CasTicketFactory $casTicketFactory)
  {
    try {
      ...
      $samlRsp .= '<Assertion xmlns="urn:oasis:names:tc:SAML:1.0:assertion" AssertionID="_e5c23ff7a3889e12fa01802a47331653" IssueInstant="' . $start . '" Issuer="https://www.sample.com" MajorVersion="1" MinorVersion="1">';
